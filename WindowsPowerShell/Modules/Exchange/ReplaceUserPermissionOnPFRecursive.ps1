<#
.EXTERNALHELP ReplaceUserPermissionOnPFRecursive-help.xml
#>
...
function ValidateParams
{
  ...
  {
    $validInputs = $false
    $errorString += $ReplaceUserPermissionOnPF_LocalizedStrings.res_0000
  }

  if ($User -eq "")
  {
    $validInputs = $false
    $errorString += $ReplaceUserPermissionOnPF_LocalizedStrings.res_0001
  }

  if ($Permissions -eq "")
  {
    $validInputs = $false
    $errorString += $ReplaceUserPermissionOnPF_LocalizedStrings.res_0002
  }
...
Import-LocalizedData -BindingVariable ReplaceUserPermissionOnPF_LocalizedStrings -FileName ReplaceUserPermissionOnPFRecursive.strings.psd1
...
Invoke-Expression $getpfcmd | foreach {
	$permission = get-PublicFolderClientPermission -identity $_ -user $User -erroraction Stop

	if ($permission -ne $null) {
		remove-PublicFolderClientPermission -identity $_ -user $User -Confirm:$false
		add-PublicFolderClientPermission -identity $_ -user $User -AccessRights $Permissions
	}
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFDCt20RM5pWuKbY9zbZgh9Um
# v1qgggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDnzJtENzYxZq9Ct
# IcQwTtTEeydjMA0GCSqGSIb3DQEBAQUABIIBACfb8qneZXN8seRgpjPcfSl90tvE
# Vk0P3muxSpRTch08XVCS0WRHMr36vyVNsd6dkhkMUiVl3apDHztSIMhZZZcvXPWf
# Dc6ebSE0DUTTbBTmv1TH5HYAEQZEIhoZregvVS+XJ84aPK17qV4M7rU4LlMVrBT5
# vL9PqXAbybhiEugPRrlYQ993GgP4piZB5f+z46RM03fIDwxwLauLjwfbcWIZcUXy
# jlZqo5sbiY8KKH++l97k+ocG4XXPO25erZ66BHtEMIWtOrzGyqqpcXBDTLUCvBCT
# yw502/DSo+cBHfcpRs7DVVhuf4Qh5kJ0b/tgxcfI7bs6L8bJNfd6Hxmqd5U=
