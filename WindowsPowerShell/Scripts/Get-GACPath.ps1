...
function Get-GACPath {
  <#
    .SYNOPSIS
        Gets global assembly cache path.
    .OUTPUTS
        String
    .NOTES
  ...
  }).GetType("$($asm).GlobalAssemblyCache").GetMethod(
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgC0tlEm6tWlTZrQGB9Qal03/
# BA+gggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFO8R3psIFqVI/Y+1
# IeRUJOaPBYtvMA0GCSqGSIb3DQEBAQUABIIBAHev0lF3XV5UMTvH1b9FVutu+qnx
# xT6W2PC3JPNjd831AIyj3p2EXdfOov/1kaAAixhwQv5V4dsbcm18N2SbrivN7Yj6
# vJwx/CfueH8E56smQKmS0l9HPC3T7wyYms2SoMWfKpekXtX5mlduYANDeiYMzVCY
# BXPJnz86fX2RtAAAi9nd+zA83I1PAhFlylC6C8LC/h6Jno7KTaBsHcNunyMfVS7v
# nvEvNs/TQLM9VERIfl4LNMeiUKD4+opxb5C938n2BVNEMq/pCKEAJ2llQx464Z8x
# ezNSHUoCD0HEXDExP0PtrhMBigHJYJyoSX5mcpO729Gaf5FIUJ3M+HPTYKE=
