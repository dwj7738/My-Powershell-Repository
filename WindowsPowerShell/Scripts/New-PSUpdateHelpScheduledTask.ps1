function New-PSUpdateHelpScheduledTask {
	...
	PROCESS{	
		...
		Register-ScheduledTaskTaskName "Update PowerShell Help" -Action $TaskAction -Trigger $TaskTrigger -RunLevel Highest -User "system" -Description "Automatically updates PowerShell help." | Out-Null
	}
	END {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdMEdXdufOmrQOU+HXfFaD8Si
# BkGgggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAkiZWX8FP/+4ulD
# NYQKcd1/aMoqMA0GCSqGSIb3DQEBAQUABIIBADx9jxHYaihJm2LU+mIdXH0hHRj9
# p6cTaKofxO2u5I6wOMz35Y3LxBHUnPB+Ki6DtL01C8WvoRXGFFDSEKduLzHL8bf/
# 6DT099M42Q7VtPvMlkYaaF6fU5Pte5gqvZJ5h+CVAeeYdzkmcXnX+y+Rx3CYdi4/
# gwUQUNRH85ZkfOlE09fb5E1GQD3h2ORBTp4MyXDyk6uLsW3AlgGRlMOQ94dmaPD3
# CZRqrXxbmu8Mkn0fZoyL8A59j7NHrO/oWKU5W3iX60HKTxInRq9sR+F2fqL2cfSL
# mdwnTtAo1bQFQUFq+hR31ltIznHmJxpinQTelV2Z67jIAimShny8bgPcCTc=
