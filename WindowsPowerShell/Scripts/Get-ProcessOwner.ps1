...
function Get-ProcessOwner {
  <#
    .SYNOPSIS
        OpenProcessToken wrapper.
    .EXAMPLE
        PS C:\> Get-ProcessOwner (Get-Process notepad)
    .OUTPUTS
        String or $null if access denied.
    .NOTES
  ...
  $GetProcessOwnerId = ([AppDomain]::CurrentDomain.GetAssemblies() | ? {
    ...
    )$(Get-Variable type -ValueOnly).Management.dll")
  }).GetType("$($type).StopProcessCommand").GetMethod(
    'GetProcessOwnerId', [Reflection.BindingFlags]36
  )
  
  $Process | % {$rt = New-Object $GetProcessOwnerId.ReflectedType}{
    try {$GetProcessOwnerId.Invoke($rt, $_)} catch {}
  }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/1zZFSM8qRV+e8zcY7Y03Qvx
# bL+gggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIcUrSEyo/hRHtZL
# GYpk+ESJfjSXMA0GCSqGSIb3DQEBAQUABIIBAFqEOffNWSe7ZB3ttvDr8S4paTjk
# kEd8raoOHWmOSuzxbvDQRtqmN0ZULq7v3tt+POOwi9Bd2VoJlIPEkl6dt9XMZ7u9
# y2i5ecuzbK2r20S48BCszHZ8InW78UVkPVBYrSHoqBEhu/b0RSb5q82aI96OEaUi
# RjtdkJnrC5kdB5aRkOu4IbTXOW/3ghb4cAYVy9zGSh5+3J1r3+XVQeaYphhU/e0O
# 3t9aweXEl20cASz6f//ZQGjdFcxI7+YVYIfsuj4K+ObMsxQg0kjWGtwU/gGxhgFK
# 0ZCVid6R2Krq8gpcRBpmSyQC3ciz3rAl52yiW4kmIoBi2hRABnsRPWEfpiw=
