...
$ConfigurationData = @{
    AllNodes = @(
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Operations Manager Database Server")
            SQLServers = @(
                @{
                    Roles = @("System Center 2012 R2 Operations Manager Database Server")
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Operations Manager Datawarehouse Server")
            SQLServers = @(
                @{
                    Roles = @("System Center 2012 R2 Operations Manager Datawarehouse Server")
                    InstanceName = "MSSQLSERVER"
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Operations Manager Reporting Server")
            SQLServers = @(
                @{
                    Roles = @("System Center 2012 R2 Operations Manager Reporting Server")
                    InstanceName = "MSSQLSERVER"
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Operations Manager Management Server")
        }
        @{
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Operations Manager Web Console Server")
        }
        @{
            NodeName = "RD01.contoso.com"
            Roles = @("SQL Server 2012 Management Tools","System Center 2012 R2 Operations Manager Console")
        }
    )
}
