...
function Show-KnownFrameworks {
  <#
    .SYNOPSIS
        Gets known for current management framework .NET platforms.
    .OUTPUTS
        Dictionary`2 <String, Boolean>
    .NOTES
        Author: greg zakharov
  #>
  
  ($ps = [PSObject].Assembly).GetType(
    "$(
      $type = 'System.Management.Automation.PsUtils'
    )$(Get-Variable type -ValueOnly)+FrameworkRegistryInstallation"
  ).GetFields(
    ($bf = [Reflection.BindingFlags]40)
  ) | % {
    $m = $ps.GetType($type).GetMethod('IsDotNetFrameworkVersionInstalled', $bf)
    $d = New-Object "Collections.Generic.Dictionary[String, Boolean]"
  }{
    $d.Add($_.Name, $m.Invoke($null, @([Version]$_.GetValue($null))))
  }{
    $d
  }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyx7Hn6BkleHHjSKQ+vryWPi1
# HyKgggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPpHf9cDyb9Yw2gn
# QOfnh3MPdFSmMA0GCSqGSIb3DQEBAQUABIIBACQ1+4bnmdF+xAZCVL/xAdkXovuC
# fd6nmab11eB2c3iiiwjjgnV2E2KZYxrRVfscfG/uhdLQ0/HsCs8dud3e8d2QI1dP
# zEyjtBpXJ3prpry70PFWL+5AwUKRtTVRStLQXMYhpj6DF7EWwPeNS2UdtEGNFU3E
# hiFRss+EYjQoh4ZlEdrPdIoeSYp6OpEOlUbBOIZoRuWYAaHmswaxLteTIid5Bktk
# 1IxdMXTk7aor8uPRT05thVAvakNSrBi3FIklvC5PXbqIdwv6wLgLxxAGADdixJ8m
# ESf6JWj32jT4Sx3zZR69jHlZ26GgAoO0K28j/E04k663iRH5pj8Xz/Awx0w=
