...
(
        ...
        $Path=[environment]::getfolderpath("myvideos") +"\TechEd2012", [Parameter(Mandatory=$false,Position=1)]
        $rssfeed="http://channel9.msdn.com/Events/TechEd/NorthAmerica/2012/RSS/mp4high"
    )
...
ConvertTo-Html -Head "<h1>My Downloaded Teched 2012 Videos - $($feeditemsSelected.Count) Downloaded</h1>" -Body $html | 
    Out-File $Path\MyTeched2012Content.html
    start "$Path\MyTeched2012Content.html"
# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUAS2ZDurwzrBttp+0+WYku6Tp
# cR+gggpaMIIFIjCCBAqgAwIBAgIQAupQIxjzGlMFoE+9rHncOTANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBM7ILXV2m4jQQg0
# 2dpBpT8/lgVUMA0GCSqGSIb3DQEBAQUABIIBAEZv+0TunZN/GJNWAwGxsXXtR+Fj
# SAJgBTtVxcV3wz8kolNa2IN9fCfqMcNOQ3GvpZeCnZlT4SVyDSVzL6c3Mfm3DL3l
# RSOZGroSk3H/yv2gz56RZDqSxV0jaTkbgqFHGZqIGr3/BM1SaAPOL82Cm8mkM882
# 6OwGWKdXmwKnJpA677nBsmtVEJhNFQ2XtyJO5JdIwi4yGDf43o7v32j/jW/9IAhx
# 9GmdwjEwCnChQEAYxwitlM7D9jroyDj52Aw9wvnSBtCUXsPsU4n6tLl7Rfh1tkVn
# DANkAWoD8Ok+NzFi4lL94RX1KIZlJpOf41h8i0eAYzJIzHpHmIqjtafOtL8=
