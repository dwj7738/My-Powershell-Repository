...
function Get-MimeType {
  <#
    .SYNOPSIS
        Returns MIME of the specified file.
    .OUTPUTS
        String
    .NOTES
  ...
  begin {
    ...
    Add-Type -AssemblyName ($asm = 'PresentationCore')
    
    $FindMimeFromData = ([AppDomain]::CurrentDomain.GetAssemblies() | ? {
  ...
  process {
    try {
      ...
      if ($FindMimeFromData.Invoke($null, (
        $res = [Object[]]($null, $FileName, $ptr, [Int32]$len, $null, 0, $mime, 0)
      )) -eq 0) {
        $res[6]
      }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU3fDWzyktj02MuCsH7q5BChyS
# 5i+gggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFET8qd9oS4hIq2uJ
# A/g8RetG/5UjMA0GCSqGSIb3DQEBAQUABIIBANiErhHIOFp9tj+4w/WEMuMJq+r6
# ZPUlE2Mc88YLp9pZg4xQ9RB6Mgd4Mc/5aw6Q6JCHrbfeqBudP6kh3CyZQpaqQOdX
# 21gYEVObvNNGPYD3VtFMQybZ7MjcH3QSA9jSpy9p6MNT8UfgpKVIw2SnjjMk/v68
# fAnNczo5YIQrWHo/ZGBjxUGYK7uwf1pERwtwGAchuP9CauUdj7oqYavpZF8aJP7M
# HfwGNEIhJGSGrfOCmXSLpEaaX/pBbk8bsBr+XA8MYxrnKKxwu7iUgjUg0p29WP6T
# opRTG+iinJTJL8UWuOB1jDeRlx6vaa4mJ9p3OTq2Akzgbtl8CWJQegCmAhM=
