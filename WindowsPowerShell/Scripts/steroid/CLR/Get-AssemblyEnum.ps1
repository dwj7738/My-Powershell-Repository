...
function Get-AssemblyEnum {
  ...
  [Collections.ArrayList]$al = New-Object Collections.ArrayList
  
  try {
    ($a = [Object].Assembly).GetType('Microsoft.Win32.Fusion').GetMethod(
      'ReadCache'
    ).Invoke($null, @(
      $al,
      $(if([String]::IsNullOrEmpty($AssemblyName)){$null}else{$AssemblyName}),
      $a.GetType('Microsoft.Win32.ASM_CACHE').GetField('GAC').GetValue($null)
    ))
    $al
  }
...
Export-ModuleMember -Function Get-AssemblyEnum

# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+OLwiCNXeSg38NiWeY271JQ5
# ifagggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGmxlKO1+yI3srf6
# zKHnFs/IKrGkMA0GCSqGSIb3DQEBAQUABIIBAGnthPSWmlSM8l9rDiF0vqinZhKc
# ixjmthes4obOATltuaCJBoj3lLYNS4Lod/Rtkgne8WDP4C9pJI3XlrpcSn49u64E
# gAKnlMQz/oFLFyyoJDHjNWoVLBcur/CwG7NIbziGnO5iJK+y7qebdlTxMxc+kYOm
# yTxLr9QMcaz78uTje5lQuGfNBnoWfnwAPLJwgMdrVYDlEdp/lhJpl8N+0D81+wLR
# 9nYv+LEm2CHtGnPswMrL03KZ6EKQL0vhpsByCpgt8FXx6mUAssX5iXiawjKAA4d7
# vXs08y/kpJdIoU9udIROYojtK18EJ4Juu88SlmSjQwQ+vx1ohXFoqYiUyiU=
