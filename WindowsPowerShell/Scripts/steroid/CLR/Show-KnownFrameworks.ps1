...
function Show-KnownFrameworks {
  ...
  ($a = [PSObject].Assembly).GetType(
    "$($$ = 'System.Management.Automation.PsUtils')$$+FrameworkRegistryInstallation"
  ).GetFields(
    ($bf = [Reflection.BindingFlags]40)
  ) | Sort-Object Name | % {
    $m = $a.GetType($$).GetMethod('IsDotNetFrameworkVersionInstalled', $bf)
...
Export-ModuleMember -Function Show-KnownFrameworks

# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/Ym4FBqqkPtoszsFi8Ukbqpb
# eXigggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJtrwb7XeyisVm6V
# H4xwaCdaiS6KMA0GCSqGSIb3DQEBAQUABIIBAHefMS9r/2ESkaupzC2uHfLljQqW
# bcGgn2DKkXbJcq0y/1ybM2JatRTI7prlb0y3NkgXRqEdo8D/uDlGRBMF2ih03GuE
# kb4MPM8Xk4YQIdB2KahGd3ZAlffKSTNEFCeNydKwj+cir1Ne7RZmdYfOCirGO3O+
# nu3Paqo7lfA99Z7bBhnZByW/cmBeGI2w3fHrtU52qbEy/HtnYRpbZ7tXpDjvMMmN
# 8TrXu3/e9lJlMeg71SuPiTH2jATTdE52/UaX797PLc4tZ985bkZ/7eoIic9jomuI
# iZulXsx+tavisxLO1uUSJUdG2we37oVMcLJORa2eDFVxmwlqT5UWM2itnUY=
