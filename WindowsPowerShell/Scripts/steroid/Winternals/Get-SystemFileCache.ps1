...
function Get-SystemFileCache {
  ...
  $PageSize = (NtQuerySystemInformation $sbi SystemBasicInformation).PageSize
  $sfi = NtQuerySystemInformation $sfi SystemFileCacheInformation
  
  $SystemFileCache = New-Object PSObject -Property @{
    MinimumWorkingSet = $sfi.MinimumWorkingSet * $PageSize / 1Kb
    MaximumWorkingSet = $sfi.MaximumWorkingSet * $PageSize / 1Kb
    PeakSize          = $sfi.PeakSize / 1Kb
    CurrentSize       = $sfi.CurrentSize / 1Kb
  }
  $SystemFileCache.PSObject.TypeNames.Insert(0, 'SystemFileCache')
  $SystemFileCache
}

Export-ModuleMember -Function Get-SystemFileCache

# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlBnEKJR4g0EvWxNvUwDNu6lb
# 1NugggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBSt5xI4C3cbdAq3
# HOttZU3xVxkgMA0GCSqGSIb3DQEBAQUABIIBAKsmjZBOjEJJszbgj9s0+x8bnr2H
# 0fX6MlBeHsCOl6NO7zBywsPC5V0UCPyvVGolhSA9DwcolCUMcXeocCwDXRGuQzbj
# GDIjf22f1KrCBBQk/vKtzbT+vWOeKTiDvq75gDkQxIDvnE+qEwbZM0VDRZTcvy+1
# TXmB7be0iqSee0gQKePCaYOMGaMDq9RpbnqTQRX/346WnJddJDKfZetUVyQQ79E8
# tpiAKk216p9xxi9gZXXUeyaeUVz8/hPptHDlC6IgyjSAZ//z5NeCN0df/IbHU10m
# +ni6ltyP4pAMNT2tGmteYUaLi/suPDHUhR/VaRMAy+cMEbVjRZ7+ZH+fVxA=
