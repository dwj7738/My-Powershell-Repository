...
function Set-Privilege {
  <#
    .SYNOPSIS
        Adjusts privilege for the given process ($PID is default).
    .EXAMPLE
...
Export-ModuleMember -Function Set-Privilege

# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUEUOvUhTRaJNg6IvlYjfOdWI5
# /zagggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMFbk8CsRpJhQbOn
# czcUKcliJkb0MA0GCSqGSIb3DQEBAQUABIIBANSj426T1y7FzkrFenJkiQLpdkd/
# AvUe6++GC3vRfPuz0jwuhmf+2Q5D0Qfbun3vo7YZTv+fgNhwL5m4JNh+/lmi9DQ5
# 1Eig/hIRBgTV7n5bsI/cpyJ129gcmuNBh9CLsE5uXdiTcU3La7AbEsxUa7OL1ZnJ
# At0KVJ4mOEbj9kY8V6WZ7r0C0YzVu+baBfaifATjuyqZCpZSJ2NQvGRJq/ihaGXX
# tNJQltDZhk3C/lwoL7xFNKXU0B8E+oJYGlUOQ/MQf4vddMew9+naC/6SK5uOXiUh
# eevClbh8F0EBtnaZeOSCFYerB3r4XUBHTJ54d2TvOORyGgED/TqHp5WMOIs=
