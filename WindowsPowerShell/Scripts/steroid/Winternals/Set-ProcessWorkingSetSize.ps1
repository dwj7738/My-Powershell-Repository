...
function Set-ProcessWorkingSetSize {
  <#
    .SYNOPSIS
        kernel32.dll!SetProcessWorkingSetSize wrapper.
    .OUTPUTS
        Boolean
    .NOTES
  ...
  (delegate kernel32.dll SetProcessWorkingSetSize Boolean @(
    [IntPtr], [Int32], [Int32]
  )).Invoke((Get-Process -Id $Id).Handle, -1, -1)
}

Export-ModuleMember -Function Set-ProcessWorkingSetSize

# SIG # Begin signature block
# MIINGAYJKoZIhvcNAQcCoIINCTCCDQUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdVBTi3fWhgwbjbp/NFmMdWQY
# q5mgggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNXfsYXQ1+izfQZI
# 3b8yorW6p4vvMA0GCSqGSIb3DQEBAQUABIIBAAhHRRwErPGa6Jgw5udN98NgpvOW
# lnhCvwrx6iuC4CsFujb93EHbfObSpNhqQdmLZeCSMB4x4slzOkGAD1tb1J3eVk0T
# aAj5XC23WO/Mlj36Q4EQmsH1ZPnqV3Pxm/czGgF5iybm21bdxNe7F8Vd2Qgs4ePy
# q+TGDR0P+8zQnmqrk9/5dYMtGchkv/h+Zzyt79L1SPOoT1QQgAK8k8/BgvTCXKwB
# rLgTO8OfqX1kqvh+hlFejpqcBQbbpA0Zo10DOv7AwUoxdmJMY6ThG315zGSMRvTe
# UtSHdo38YkEQ7LY+HUa1FmOc2J2y54jdRasYm3PWgXMF5YJGBRhFRNTTuhw=
