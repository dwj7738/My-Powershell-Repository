...
Foreach ($insecureCipher in $insecureCiphers) {
  $key = (Get-Item HKLM:\).OpenSubKey('SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers', $true).CreateSubKey($insecureCipher)
  New-ItemProperty -path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\$insecureCipher" -name 'Enabled' -value '0xffffffff' -PropertyType 'DWord' -Force
  $key.close()
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVEcX5BXmLGBhCZZF42jTJH9h
# lFmgggpaMIIFIjCCBAqgAwIBAgIQAupQIxjzGlMFoE+9rHncOTANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJZMuYQw/OnSX+Mg
# Z0uGMDH4xA3IMA0GCSqGSIb3DQEBAQUABIIBAETqPth4TvtCYILaAm7r188MB1VS
# hkEubPFfBs4x1cugdFh1njL12QW61FDBSzRYBUmwUDEiLsjfpoB7Fz71T5JUrhxM
# toQI3aAedv012FTrPfVRx3Ri0D6gmnw0w+tVv6VdUt7079jqJRDCLCh9haYcNRrk
# +r0rhiBSAu7ZqUSx5+5sakyqDTyNQgp/sT4jM59vcYqj67QBsW5usrZGgUR5Jyz4
# 931ke3/UBmtF2U223q3Jt8vRkoF/wevki0cp2+sF4iiwVVRl9mc3Iftc8EKcaU+M
# Bc8fFSSpUBRxsM/Hwhqc51Ysk/9/4yvcymijgEmQAQsX0rm4kXmE+b7DhJg=
