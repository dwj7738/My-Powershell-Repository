...
function Get-Calendar {
  <#
    ...
    .EXAMPLE
        PS C:\> Get-Calendar -mf
    .EXAMPLE
        PS C:\> Get-Calendar -m 10 -y 2013 -mf
    .NOTES
  ...
  begin {
    ...
    $add = {
      param([String]$NameSpace, [ScriptBlock]$Import)
      
      $ret = $null
      $arr = [Array]$ta::Get.Keys
      
      [Management.Automation.PSParser]::Tokenize($Import, [ref]$ret) | % {
        if ($_.Type -match 'Command' -and $arr -notcontains $_.Content) {
          $ta::Add($_.Content, ("$($NameSpace)." + [String]$_.Content))
        }
      }
    } #end add
    
    $add.Invoke('Globalization', {DateTimeFormatInfo, CultureInfo})
    
    [DateTimeFormatInfo]::CurrentInfo.ShortestDayNames | % {$arr = @()}{$arr += $_}
  ...
  process {
    $loc = [DateTimeFormatInfo]::CurrentInfo.MonthNames[$Month - 1] + ' ' + $Year
    ...
    [void]$ta::Remove('DateTimeFormatInfo')
    [void]$ta::Remove('CultureInfo')
  }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwj2w+thpwTbprVFeWYSGpM5F
# l8KgggpaMIIFIjCCBAqgAwIBAgIQBg4i3l65iHFvsYhyMrxXATANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMcarVEZlBaVk7Ev
# QY6iXJx0KdxvMA0GCSqGSIb3DQEBAQUABIIBAENOR+MN7gbgPCx6RbWoP5BRaa2s
# 4IIO/LbkDw+Ohq9WuuNaDLLESh0Aj+3JORN4UTjc2B7RjXK5zy0biH8lJNZL9NJh
# SpT5i9d5EGfMOE3a43geaBRUcSw/Sgw5zx9uj1jjDSuPO99f3XdVdVhPjzcaxgpN
# nIp5O43T87v3Fovy6zmeHjN6nRXaJFVcmveU9hx49yAYcGCyKAsVHP1hS4rPB6WD
# qT78375uop8F3QNxnXZYEadjCSuFSIC+FI55+eOqLDvOL0MBpKp6LMB/pbMlxZqF
# rRfUOr6D/Po31NXcNKymq+lbWMhY7QRfGLGqRXcWoVjM3gcmuT3YHx9+fAI=
