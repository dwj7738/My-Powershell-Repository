...
Begin
{
	...
	Function GetNestedGroups ($strGroupDN) {
		$currentGroupmemberships = (Get-ADGroup $strGroupDN â??Properties MemberOf | Select-Object MemberOf).MemberOf
	...
	Function FindGroupMembership ($strUsername) {
		...
		$directMembershipGroups = (Get-ADUser $strUsername â??Properties MemberOf | Select-Object MemberOf).MemberOf
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUzrgRTM+xuLKiXOo0MZ7zXbfw
# peSgggpaMIIFIjCCBAqgAwIBAgIQAupQIxjzGlMFoE+9rHncOTANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIKMgqf9V8iKrvN7
# kY7EdoK38ZlIMA0GCSqGSIb3DQEBAQUABIIBAC/V8KPFRF4vBgWc286Y6Qp7HmAV
# fMwxq5IFm/zsVjlWJ97ZYdXJa/mzxjRQdIMLpdLlO7oeboG/xZDN2uKxsjsKFvOx
# aZRtCZT6gZlgxwl9ibwvCZG1JDhkSMXoAPsXQbmooUN0AJelw5eQHMhutkvocCeS
# X9xEHPK3n/hzRTn7NohUGheOxxunZomfGjQ/9/IdXNjyZdxDExFnuY/YEZr8EVJs
# gND+9UNXfokRZDoBSVnShFapP5Bc5Tg2KYdytNLzTFZbV1zUYrgbb5FtnIYxPENJ
# nk8LhcVCoi6nv8WkWK2hFYxZdf7Sg9s9M+pVZsDdRYiepV9FI1Yq60DXEYs=
