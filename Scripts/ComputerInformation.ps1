...
$objNotifyIcon.Icon = "M:\Checked\YencPowerPostA&A11b_sources\res\error.ico"
...
# Write-Warning ('Open Registry Failed {0} : {1}')
}

 Open Remote Sub Key
try {	$regKey= $reg.OpenSubKey($Key) }
catch {
#    Write-Warning ('Open Remote Sub Key Failed {0} : {1}')
    }
...
#region Computer Total Health
			...
			# Using the Avialable Memory to Check Computer Total Health
...
#region Creating the Data Object - $DataObject
			...
			$ComputerTotalHealth | Join-Data -objName "Computer Total Health" # String with no Values - Define a Name
#endregion
...
# Assign an Icon and Icon Type For the NotifyIcon Object
$objNotifyIcon.Icon = "M:\Checked\YencPowerPostA&A11b_sources\res\stopwatch.ico"
$objNotifyIcon.BalloonTipIcon = "Info" 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4FkuK5dQhUD0f0GDNwvGrJWk
# mlagggpaMIIFIjCCBAqgAwIBAgIQAupQIxjzGlMFoE+9rHncOTANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFA8vX89WG3/DKjlE
# npHGFqjcMaW4MA0GCSqGSIb3DQEBAQUABIIBAFPpP77KUf/CHVcgMbeVBRU4NaWP
# kqNWXhcY5U/W7FOa14AkAK8cF6+2jAYFD0VT7gesKvU5IwThuZEV4aoWT7CAJi6d
# H5ugMxeaHO4idN4xDGBQH/jsImQDV5aRjq5pPD4lvrZ6gyUl8HwbdDizdt2bl8qT
# 04Yyap73uqB60z8IiIsKQV2Tve3tLRr8RBnwnUchhvNwiSRlX3dtvnHDhPG2iC/Y
# ZgzWAbt9ZGvc0PEX0o3Knu8jU0+/V7I3kAcMFyMRAC3yV2WFrYUdH741xfw3BkHQ
# p98gqEB7WZMPuQyS4zB3MOu2q/aKPqN9LSzpmyXjt2ltVmshD4/FEKSqm7k=
