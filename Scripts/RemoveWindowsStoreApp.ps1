...
function Remove-OSCAppxPackage
{
	<#
		.SYNOPSIS
			The Remove-OSCAppxPackage command will remove Windows Store Appx packages.

		.DESCRIPTION
			This command can help you to remove several Windows Store Apps at one time.  
			
		.EXAMPLE
			PS C:\> Remove-OSCAppxPackage
			
			Description
			-----------
			List all Windows Store apps, and remove the apps specified by user.
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUEH1knhpN/W7saukRrfbvG01T
# xGKgggpaMIIFIjCCBAqgAwIBAgIQAupQIxjzGlMFoE+9rHncOTANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFF5cTdeO8cSvlE7I
# /iZOdZoagSULMA0GCSqGSIb3DQEBAQUABIIBAKjuhGyON37wRKxsqjuyyArStO0d
# 9rgg1GlfytCNcygMzLbt7J8m3jGfUN3NXSYMJZrh7fKjzADLRI8OwU+H2SRMxxJf
# m3QBvYtFQfCWvFEKuLIwGyoskGfGJPkhF65nAlWb/CeaqXk3IKPxggLdwTh4c6nn
# ls9r8k0sxUnGLQLXa5KtcmWcSg29ww76p1Yz8g7ECEo7QemwGQ/sNKKA6hOc9yil
# YQBMV0YVhTHq+blCkcrY5m6L1nwSHkrXduJKijAkYb+ALe5Jg0CyVm2cX1sh9BFh
# SPjutDwL78RuNGjTeEfRCTKySU91HR0VmEtIylumC1TzvbWXi/RPMqTKW8Q=
